...
import { IProblemMatcher, FileLocationKind, ProblemPattern, ApplyToKind } from 'vs/workbench/contrib/tasks/common/problemMatcher';
...
function assertProblemMatcher(actual: string | IProblemMatcher, expected: string | IProblemMatcher) {
	assert.strictEqual(typeof actual, typeof expected);
