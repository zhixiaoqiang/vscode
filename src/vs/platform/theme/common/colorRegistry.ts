...
export const selectionBackground = registerColor('selection.background', { light: transparent(foreground, 0.4), dark: transparent(foreground, 0.25), hc: focusBorder }, nls.localize('selectionBackground', "The background color of text selections in the workbench (e.g. for input fields or text areas). Note that this does not apply to selections within the editor."));
